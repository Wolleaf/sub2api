...
export interface ApiKey {
  ...
  upstream_weekly_limit_percent?: number
  upstream_weekly_usage_percent?: number
  upstream_weekly_window_start?: string | null
  upstream_weekly_observed_at?: string | null
  usage_5h: number
  usage_1d: number
  usage_7d: number
