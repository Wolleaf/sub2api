export default {
  ...
  keys: {
    ...
    upstreamWeeklyQuota: 'Upstream weekly share',
    upstreamWeeklyQuotaNote: 'Estimated allocation of shared account usage increments, synced each minute and reset with the upstream week. Dollar billing is separate from this allowance.',
