export default {
    ...
    groups: {
      ...
      weeklyBypass: {
        action: 'Open Weekly Limit',
        active: 'Limit Open',
        enable: 'Enable',
        disable: 'Restore Limit',
        enableTitle: 'Open Weekly Limit',
        disableTitle: 'Restore Weekly Limit',
        enableHint: 'Temporarily bypass API-key 7-day spending limits in this group',
        activeHint: 'The 7-day limit is temporarily open and will be restored around {time}',
        enableConfirm: 'The current weekly window for "{name}" started at {start}. Enabling this will let {count} API keys with weekly limits use the service as unlimited while preserving their configured USD limits and usage. Limits will be restored around {time}. Continue?',
        disableConfirm: 'Restoring limits for "{name}" immediately reapplies each key\'s configured weekly limit to its current weekly usage. Usage will not be reset. Continue?',
        enabledSuccess: 'Weekly limit opened for {count} keys; it will be restored around {time}',
        disabledSuccess: 'Weekly limits restored',
        previewFailed: 'Could not confirm the upstream weekly window; no change was made',
        updateFailed: 'Failed to update weekly limit bypass',
        unknownTime: 'unavailable'
      },
      sortOrder: 'Sort',
      columnSettings: 'Column Settings',
