export default {
    ...
    groups: {
      ...
      weeklyBypass: {
        ...
        enableTitle: '开启一键开蹬',
        disableTitle: '关闭一键开蹬',
        enableHint: '临时豁免本分组 API Key 的 7 天额度限制',
        activeHint: '7 天额度已临时放开，预计 {time} 自动恢复',
        enableConfirm: '分组「{name}」当前周窗口从 {start} 开始。开启后，{count} 把配置了周限额的 API Key 将临时显示并按无限额度使用；原始周限额和用量仍会保留，预计 {time} 自动恢复。是否继续？',
        disableConfirm: '关闭分组「{name}」的一键开蹬后，原有周限额会立即按当前周用量重新生效，不会清零用量。是否继续？',
        enabledSuccess: '一键开蹬已开启，已放开 {count} 把 Key，预计 {time} 自动恢复',
        disabledSuccess: '一键开蹬已关闭，原有周限额已恢复',
        previewFailed: '无法确认上游周窗口，未开启一键开蹬',
        updateFailed: '更新一键开蹬状态失败',
        unknownTime: '暂不可用'
      },
      sortOrder: '排序',
      columnSettings: '列设置',
