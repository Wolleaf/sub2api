...
func createGroupRecord(ctx context.Context, client *dbent.Client, groupIn *service.Group) error {
	...
	builder := client.Group.Create().
		...
		SetWeeklyRateLimitBypassEnabled(groupIn.WeeklyRateLimitBypassEnabled).
		SetNillableWeeklyRateLimitBypassWindowStart(groupIn.WeeklyRateLimitBypassWindowStart)
...
func (r *groupRepository) Update(ctx context.Context, groupIn *service.Group) error {
	...
	if groupIn.WeeklyRateLimitBypassWindowStart != nil {
		builder = builder.SetWeeklyRateLimitBypassWindowStart(*groupIn.WeeklyRateLimitBypassWindowStart)
	} else {
		builder = builder.ClearWeeklyRateLimitBypassWindowStart()
	}
