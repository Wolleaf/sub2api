...
func registerGroupRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	groups := admin.Group("/groups")
	{
		...
		groups.GET("/:id/weekly-rate-limit-bypass", h.Admin.Group.GetWeeklyRateLimitBypass)
		...
		groups.PUT("/:id/weekly-rate-limit-bypass", h.Admin.Group.UpdateWeeklyRateLimitBypass)
