...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	readonlyAdminService := service.NewReadonlyAdminService(userRepository, groupRepository, accountRepository)
	readonlyHandler := admin.NewReadonlyHandler(readonlyAdminService)
	...
	openAIWeeklyResetSyncRepository := repository.NewOpenAIWeeklyResetSyncRepository(db)
	...
	openAIWeeklyResetSyncService := service.ProvideOpenAIWeeklyResetSyncService(openAIWeeklyResetSyncRepository, openAIQuotaService, billingCacheService, apiKeyAuthCacheInvalidator)
	groupHandler := admin.NewGroupHandler(adminService, dashboardService, groupCapacityService, openAIWeeklyResetSyncService)
	...
	openAIModelSyncWriter := repository.NewOpenAIModelSyncRepository(db)
	openAIModelSyncService := service.ProvideOpenAIModelSyncService(accountRepository, accountTestService, openAIModelSyncWriter, configConfig)
	...
	v := provideCleanup(client, redisClient, opsMetricsCollector, opsAggregationService, opsAlertEvaluatorService, opsCleanupService, opsScheduledReportService, opsSystemLogSink, opsService, opsIngressRejectAggregator, apiKeyService, authCacheInvalidationWorker, schedulerSnapshotService, tokenRefreshService, accountExpiryService, openAIWeeklyResetSyncService, openAIModelSyncService, cnProviderBalanceCheckService, openAICodexVersionSyncService, proxyExpiryService, subscriptionExpiryService, usageCleanupService, idempotencyCleanupService, batchImageCleanupService, batchImageWorkerRuntime, pricingService, emailQueueService, billingCacheService, usageRecordWorkerPool, subscriptionService, oAuthService, openAIOAuthService, geminiOAuthService, antigravityOAuthService, grokOAuthService, openAIGatewayService, scheduledTestRunnerService, backupService, paymentOrderExpiryService, channelMonitorRunner, channelMonitorV2Aggregator, userPlatformQuotaUsageFlusher, upstreamBillingProbeService, ollamaCloudUsageService, auditLogService, openAIQuotaAutoResetService, promptService, pluginManager)
