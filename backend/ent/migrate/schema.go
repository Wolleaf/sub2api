...
var (
	...
	APIKeysColumns = []*schema.Column{
		...
		{Name: "upstream_weekly_limit_percent", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "decimal(10,6)"}},
		{Name: "upstream_weekly_usage_percent", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "decimal(10,6)"}},
		{Name: "upstream_weekly_window_start", Type: field.TypeTime, Nullable: true},
		{Name: "upstream_weekly_observed_at", Type: field.TypeTime, Nullable: true},
	...
	GroupsColumns = []*schema.Column{
		...
		{Name: "weekly_rate_limit_bypass_enabled", Type: field.TypeBool, Default: false},
		{Name: "weekly_rate_limit_bypass_window_start", Type: field.TypeTime, Nullable: true},
	}
