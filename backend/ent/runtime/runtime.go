...
func init() {
	...
	// apikeyDescUpstreamWeeklyLimitPercent is the schema descriptor for upstream_weekly_limit_percent field.
	apikeyDescUpstreamWeeklyLimitPercent := apikeyFields[15].Descriptor()
	// apikey.DefaultUpstreamWeeklyLimitPercent holds the default value on creation for the upstream_weekly_limit_percent field.
	apikey.DefaultUpstreamWeeklyLimitPercent = apikeyDescUpstreamWeeklyLimitPercent.Default.(float64)
	// apikeyDescUpstreamWeeklyUsagePercent is the schema descriptor for upstream_weekly_usage_percent field.
	apikeyDescUpstreamWeeklyUsagePercent := apikeyFields[16].Descriptor()
	// apikey.DefaultUpstreamWeeklyUsagePercent holds the default value on creation for the upstream_weekly_usage_percent field.
	apikey.DefaultUpstreamWeeklyUsagePercent = apikeyDescUpstreamWeeklyUsagePercent.Default.(float64)
	...
	groupDescWeeklyRateLimitBypassEnabled := groupFields[63].Descriptor()
